...
namespace Nexmo.Api
{
    ...
    public static class Number
    {
        ...
        {
            return ApiRequest.DoGetRequestWithQueryParameters<SearchResults>(ApiRequest.GetBaseUriFor(typeof(Account), "/account/numbers/"), ApiRequest.AuthType.Query, request, creds);
        }
        /// <summary>
        ...
        {
            return ApiRequest.DoGetRequestWithQueryParameters<SearchResults>(ApiRequest.GetBaseUriFor(typeof(Number), "/number/search/"), ApiRequest.AuthType.Query, request, creds);
        }
